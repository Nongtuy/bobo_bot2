...
const double WHEEL_RADIUS = 0.022;
...
void set_pwm_values() {
  ...
  digitalWrite(enA, pwmLeftOut);
  digitalWrite(enA_2, pwmLeftOut);
   
  digitalWrite(enB, pwmRightOut);
  digitalWrite(enB_2, pwmRightOut); 
}
...
void setup() {
  ...
  digitalWrite(enA_2, 0); 
  digitalWrite(enB_2, 0);
